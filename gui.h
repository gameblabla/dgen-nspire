...
#define TITLE_WINDOW "DGEN"

#define FORMAT_FILE ".md"
#define EXECUTABLE_NAME "dgeb.tns"
#define DEFAULT_TEXT "   Select a Megadrive riom file"
#define CREDITS_TEXT "   Dgen ported by gameblabla"
